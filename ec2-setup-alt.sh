...
# ZapDeals EC2 Alternative Setup Script
# This script uses a Python virtual environment to avoid conflicts with system packages

set -e  # Exit immediately if a command exits with a non-zero status

echo "===== ZapDeals EC2 Alternative Setup Script ====="
...
# Create backend service file with virtual environment
...
ExecStart=/home/$(whoami)/zapdeals-demo/backend/venv/bin/uvicorn main:app --host 0.0.0.0 --port 8000
Restart=always
RestartSec=10
...
echo ""
echo "To manually start the backend (if service fails):"
echo "cd ~/zapdeals-demo/backend"
